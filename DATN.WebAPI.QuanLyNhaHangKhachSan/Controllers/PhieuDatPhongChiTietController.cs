...
namespace DATN.WebAPI.QuanLyNhaHangKhachSan.Controllers
{
    ...
    public class PhieuDatPhongChiTietController : Controller
    {
        ...
        public async Task<ActionResult<ResponseDTO>> ThemPhieuDatPhongChiTiet(PhieuDatPhongChiTiet obPhieuDatPhongChiTiet)
        {
            ResponseDTO responseDTO = new ResponseDTO();
            try
            {
        ...
        public async Task<ActionResult<ResponseDTO>> CapNhatPhieuDatPhongChiTiet(PhieuDatPhongChiTiet obPhieuDatPhongChiTiet)
        {
            ResponseDTO responseDTO = new ResponseDTO();
            try
            {
